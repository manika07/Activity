...
Creating new variables, weekdays and weekends in the new data

```{r,echo=TRUE}

newactivity$weekXXX <- format(newactivity$date, "%u")
newactivity$weekXXX[newactivity$weekXXX %in% 1:5] <- "weekday"
newactivity$weekXXX[newactivity$weekXXX %in% 6:7] <- "weekend"
newactivity$weekXXX <- as.factor(newactivity$weekXXX)
